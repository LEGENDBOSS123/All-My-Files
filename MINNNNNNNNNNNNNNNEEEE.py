...
class PLAYER():
    ...
    def PLACE(self, cubes):
        # Sort all the cubes based on the distance from the Player/Self
        cubes2 = []
        for cube in cubes:
        ...
        for cube in cubes2:
            # draw_sides has distances from all faces to the player. 
            draw_sides = []
            for face in faces:
                # sides is set with the displacement vector in the x, y and z axes.
                sides = []
                # For all vertices of the Face vertex
                for vertex in (verticies[face[0]],verticies[face[1]],verticies[face[2]],verticies[face[3]]):
                    old_x = vertex[0]-self.x+cube[0]
                    old_y = vertex[1]-self.y+cube[1]
                    old_z = vertex[2]-self.z+cube[2]   
            ...
            for face in (faces[faces1],faces[faces2],faces[faces3],faces[faces4],faces[faces5],faces[faces6]):
                ...
                for vertex in (verticies[face[0]],verticies[face[1]],verticies[face[2]],verticies[face[3]]):
                    ...
                    if old_z>0:
                        ...
                        new_x = self.calculation/old_z * old_x
                        new_y = self.calculation/old_z * old_y
                        new_x+=xval//2
                        new_y+=yval//2
